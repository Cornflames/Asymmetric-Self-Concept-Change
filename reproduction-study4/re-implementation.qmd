...
In dieser Datei wird eine vollständige Re-Implementation-Reproduction von Studie 4 aus Brotzeller & Gollwitzer (2025) nach den Schritten durchgeführt, die das *Conceptual-Framework-for-Computational-Reproductions* (Kohrt et al., 2024) vorgibt. Eine besser lesbare HTML-Version dieser Datei befindet sich in den [Zusatzmaterialien](https://github.com/Cornflames/Asymmetric-Self-Concept-Change.git) der vorliegenden Bachelorarbeit.
