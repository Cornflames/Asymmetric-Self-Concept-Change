...
Die Annahmen der Theorie werden in \td analysiert. Auf Grundlage dieser Analyse wird in \td der Versuch unternommen, ein formales Modell der Theorie abzuleiten. Um zu überprüfen, ob ein formales Modell das Phänomen produzieren kann, muss dieses zuerst als statistisches Muster repräsentiert werden, was wiederum nur möglich ist, wenn das Phänomen klar definiert ist. Die Präzision der Definition des Phänomens wird in \td analysiert. Um dieser Analyse folgen zu können, benötigt man jedoch zunächst ein grundlegendes Verständnis für das verwendete Untersuchungsparadigma und die darin vorkommenden Variablen.
