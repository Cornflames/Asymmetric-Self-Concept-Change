\begin{xltabular}{\linewidth}{l >{\RaggedRight\hsize=1.4\hsize}X >{\RaggedRight\hsize=0.9\hsize}X c >{\RaggedRight\hsize=0.7\hsize}X r}
    ...
    \multicolumn{6}{p{\linewidth}}{%
        \footnotesize \textit{Hinweis.} Alle Zitate stammen aus \textcite{brotzeller_exploring_2025}. Aus den jeweiligen Zitaten werden die einzelnen Aussagen bzw. Annahmen extrahiert, die sie beinhalten. Die Annahmen 1--18 betreffen die Definitionen von Phänomenen und Variablen, die im verwendeten Untersuchungsparadigma auftreten können bzw. eine Rolle spielen, die Annahmen 19--45 hingegen die Annahmen der von den Autoren dargestellten Theorie. Zur Vorbereitung auf die Erstellung von VAST"=Displays wird jede Annahme als Beziehung zwischen gewissen Konzepten ausgedrückt. Jeder Annahme werden die sie konstituierenden Konzepte zugeordnet. Ein Konzept kann dabei in beliebig vielen Annahmen vorkommen. Ein Higher"=Order"=Concept (HOC) umschließt die darauffolgenden Konzepte.
    } \\
    \endlastfoot
...
SELF"=CONCEPT CHANGE & \hypertarget{id13}{13} \\\\
    ...
    \addlinespace
         & 
         & Self-concept change has occurred when self-perception_{t1} differs from self-perception_{t2} 
    ...
    \addlinespace
         ...
         & i & SELF-IMPROVEMENT MOTIVE, HOC: PERCEPTION OF FEEDBACK, INFORMATIONAL VALUE OF NEGATIVE FEEDBACK & \hypertarget{id32}{32} \\
    \addlinespace
         & 
    ...
    In such cases, the only possibility of maintaining one’s positive self-view is to self-enhance. Perceiving little opportunity for improvement should therefore trigger self-enhancement and produce positively biased self-concept change.}
