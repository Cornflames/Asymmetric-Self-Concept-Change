...
\shorttitle{Theorieformalisierung von Brotzeller und Gollwitzer (2025)} % The short title for the header
\authorsnames{\phantom{Benedikt Daniel Ehrenwirth}}
% \authorsnames{Benedikt Daniel Ehrenwirth\\Matrikelnummer: 12576722}
\authornote{%
    Benedikt Daniel Ehrenwirth\\
    Student an der Ludwig-Maximilians-Universität München\\
    Dr. Dürrwanger Str. 31b\\
    86156 Augsburg\\
    Matrikelnummer: 12576722\\
    Email: \url{B.Ehrenwirth@campus.lmu.de}
}
\note{Zeichenzahl (mit Leerzeichen): 83\,161}
\duedate{Abgegeben am: 13. Januar 2026}
% \date{January 17, 2024} The student version doesn't use the \date command, for whatever reason
\authorsaffiliations{
% Ludwig-Maximilians-Universität
}
\course{\textbf{Bachelorarbeit}} % LaTeX gets annoyed (i.e., throws a grumble-error) if this is blank, so I put something here. However, if your instructor will mark you off for this being on the title page, you can leave this entry blank (delete the PSY 4321, but leave the command), and just make peace with the error that will happen. It won't break the document.
\professor{Betreuer: Dr. Philipp Sckopke}  % Same situation as for the course info. Some instructors want this, some absolutely don't and will take off points. So do what you gotta.
...
\begin{document}
    ...
    \include{report/appendices/appendix_b}
    \include{report/appendices/erklaerung}
    \include{report/appendices/rechtsverbindlich}
\end{document}